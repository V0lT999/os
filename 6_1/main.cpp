...
const LPCSTR MAP_FILE = "D://NIR_dir//os//os//map_file.txt";
const string WLOG_FILE = "D://NIR_dir//os//os//writer.txt";
const string RLOG_FILE = "D://NIR_dir//os//os//reader.txt";

const string WPATH = "D://NIR_dir//os//os//6_2//6_2.exe"; //writer
const string RPATH = "D://NIR_dir//os//os//6_3//6_3.exe"; //reader
